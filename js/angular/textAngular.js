! function(a, b) {
    b["true"] = a, angular.module("textAngularSetup", []).value("taOptions", {
            ...
            angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function(b) {
                ...
                //iconclass: "fa fa-quote-right",
                //tooltiptext: c.quote.tooltip,
            	display: "<span class='bar-btn-dropdown dropdown'><span ng-class='{open:toggleDropdown==true}' ng-init='toggleDropdown=false'> " +
				"<span ng-disabled='showHtml()' ng-click='toggleDropdown =!toggleDropdown'>{{active}} </span>" +
				"<ul class='dropdown-menu' ng-click='toggleDropdown =false'><li ng-repeat='o in options' ><a href='' class='checked-dropdown {{o.name}}' style='font-family: {{o.css}}' ng-click='action(o.name);'><i ng-if='o.active' class='fa fa-check'></i>{{o.name}}</a></li></ul></span></span>",
    			...
    			options: [
    						...
    						{name: 'ComicSansMS', css: "'comic sans ms', sans-serif"},
    						{name: 'CourierNew', css: "'courier new', monospace"},
    						{name: 'Garamond', css: 'garamond, serif'},
    						{name: 'Georgia', css: 'georgia, serif'},
    						{name: 'Tahoma', css: 'tahoma, sans-serif'},
    						{name: 'TrebuchetMS', css: "'trebuchet ms', sans-serif"},
    						{name: "Helvetica", css: "'Helvetica Neue', Helvetica, Arial, sans-serif"},
    						{name: 'Verdana', css: 'verdana, sans-serif'},
    						{name: 'ProximaNova', css: 'proxima_nova_rgregular'}
    					],
    					active: 'Font Family',
            	...
            	display: "<span class='bar-btn-dropdown dropdown'><span ng-class='{open:toggleFontSize==true}' ng-init='toggleFontSize=false'>" +
				"<span ng-disabled='showHtml()' ng-click='toggleFontSize =!toggleFontSize'><i class='fa fa-font'></i><i class='fa fa-caret-down'></i></span>" +
				"<ul class='dropdown-menu' ng-click='toggleFontSize=false'><li ng-repeat='o in options'><a style='font-size:{{o.css}};' href='' class='checked-dropdown {{o.css}}'  ng-click='action(o.css)'><i ng-if='o.active' class='fa fa-check'></i> {{o.name}}</a></li></ul>" +
				"</span>",
				...
				setActive: function(size) {
					// Convert to string if not already
					if (typeof size !== 'string') { size = String(size) };
					angular.forEach(this.options, function(option) {
						option['active'] = size === option.value ? true : false;
					});
				},
				getActive: function() {
            	...
            	display: "<span class='bar-btn-dropdown colorpickerBtn'><button type='button' colorpicker colorpicker-text-editor='true' colorpicker-parent='true' class='btn btn-default' ng-disabled='showHtml()'> <i class='fa fa-magic'></i><i class='fa fa-caret-down'></i></button></span>",
            	action: function() {
    				color=this.$element.children()[0].value;
    				if (color !== '') {
            ...
            m.constant("taRegisterTool", c), m.value("taTools", n), m.config([function() {
                ...
                return {
                    ...
                    link: function(j, p, q, r) {
                        var s, t, u, v = void 0 !== p.attr("contenteditable") && p.attr("contenteditable"),
                            w = v || "textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase(),
                            x = !1,
                            y = !1,
                            z = q.taUnsafeSanitizer || o.disableSanitizer;
                        void 0 === q.taDefaultWrap && (q.taDefaultWrap = "p"), "" === q.taDefaultWrap ? (s = "", t = void 0 === e ? "<div><br></div>" : e >= 11 ? "<p><br></p>" : 8 >= e ? "<P>&nbsp;</P>" : "<p>&nbsp;</p>", u = void 0 === e ? /^<div>(\s|&nbsp;)*<\/div>$/gi : /^<p>(\s|&nbsp;)*<\/p>$/gi) : (s = void 0 === e || e >= 11 ? "<" + q.taDefaultWrap + "><br></" + q.taDefaultWrap + ">" : 8 >= e ? "<" + q.taDefaultWrap.toUpperCase() + "></" + q.taDefaultWrap.toUpperCase() + ">" : "<" + q.taDefaultWrap + "></" + q.taDefaultWrap + ">", t = void 0 === e || e >= 11 ? "<" + q.taDefaultWrap + "><br></" + q.taDefaultWrap + ">" : 8 >= e ? "<" + q.taDefaultWrap.toUpperCase() + ">&nbsp;</" + q.taDefaultWrap.toUpperCase() + ">" : "<" + q.taDefaultWrap + ">&nbsp;</" + q.taDefaultWrap + ">", u = new RegExp("^<" + q.taDefaultWrap + ">(\\s|&nbsp;)*<\\/" + q.taDefaultWrap + ">$", "ig")), p.addClass("ta-bind");
                        var A = function() {
                                if (v) return p[0].innerHTML;
                                if (w) return p.val();
                                throw "textAngular Error: attempting to update non-editable taBind"
                            },
                            B = function(a) {
                                a || (a = A()), a === t || a.match(u) ? "" !== r.$viewValue && r.$setViewValue("") : r.$viewValue !== a && r.$setViewValue(a)
                            };
                        if (j.$parent["updateTaBind" + (q.id || "")] = function() {
                            ...
                            if (v) {
                                if (p.on("cut", function(a) {
                                        x ? a.preventDefault() : b(function() {
                                            B()
                                        }, 0)
                                    }), p.on("paste", function(a, b) {
                                        b && angular.extend(a, b);
                                        var d;
                                        if (a.clipboardData || a.originalEvent && a.originalEvent.clipboardData ? d = (a.originalEvent || a).clipboardData.getData("text/plain") : c.clipboardData && (d = c.clipboardData.getData("Text")), !d && !x) return !0;
                                        if (a.preventDefault(), !x) {
                                        ...
                                        if (b && angular.extend(a, b), !x) {
                                            ...
                                            var e = A();
                                            "" !== s && "" === e.trim() && (p[0].innerHTML = s, k.setSelectionToElementStart(p.children()[0])), B(e)
                                        }
                                    }), p.on("blur", function() {
                                        y = !1, x || B(), r.$render()
                                    ...
                                    C = g("#" + q.id + ".placeholder-text:before", 'content: "' + q.placeholder + '"'), j.$on("$destroy", function() {
                                        h(C)
                                    })
                                }
                                p.on("focus", function() {
                        ...
                        var D = function(b) {
                                return r.$oldViewValue = a(i(b), r.$oldViewValue, z)
                            },
                            E = function(a) {
                                return q.required && r.$setValidity("required", !(!a || a.trim() === t || a.trim().match(u) || "" === a.trim())), a
                            };
                        r.$parsers.push(D), r.$parsers.push(E), r.$formatters.push(D), r.$formatters.push(E);
                        var F = function(a) {
                                return j.$emit("ta-element-select", this), a.preventDefault(), !1
                            },
                            G = function(a, c) {
                                if (c && angular.extend(a, c), !l && !x) {
                                    l = !0;
                                    var d;
                        ...
                        j.$parent["reApplyOnSelectorHandlers" + (q.id || "")] = function() {
                            x || angular.forEach(m, function(a) {
                                p.find(a).off("click", F).on("click", F)
                            })
                        };
                        var H = function(a) {
                            p[0].innerHTML = a
                        ...
                        r.$render = function() {
                            var a = r.$viewValue || "";
                            f[0].activeElement !== p[0] ? v ? (q.placeholder ? "" === a ? (y ? p.removeClass("placeholder-text") : p.addClass("placeholder-text"), H(s)) : (p.removeClass("placeholder-text"), H(a)) : H("" === a ? s : a), x ? p.off("drop", G) : (angular.forEach(m, function(a) {
                                p.find(a).on("click", F)
                            }), p.on("drop", G))) : "textarea" !== p[0].tagName.toLowerCase() && "input" !== p[0].tagName.toLowerCase() ? H(n(a)) : p.val(a) : v && p.removeClass("placeholder-text")
                        }, q.taReadonly && (x = j.$parent.$eval(q.taReadonly), x ? (p.addClass("ta-readonly"), ("textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase()) && p.attr("disabled", "disabled"), void 0 !== p.attr("contenteditable") && p.attr("contenteditable") && p.removeAttr("contenteditable")) : (p.removeClass("ta-readonly"), "textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase() ? p.removeAttr("disabled") : v && p.attr("contenteditable", "true")), j.$parent.$watch(q.taReadonly, function(a, b) {
                            b !== a && (a ? (p.addClass("ta-readonly"), ("textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase()) && p.attr("disabled", "disabled"), void 0 !== p.attr("contenteditable") && p.attr("contenteditable") && p.removeAttr("contenteditable"), angular.forEach(m, function(a) {
                                p.find(a).on("click", F)
                            }), p.off("drop", G)) : (p.removeClass("ta-readonly"), "textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase() ? p.removeAttr("disabled") : v && p.attr("contenteditable", "true"), angular.forEach(m, function(a) {
                                p.find(a).off("click", F)
                            }), p.on("drop", G)), x = a)
                        })), v && !x && (angular.forEach(m, function(a) {
                            p.find(a).on("click", F)
                        }), p.on("drop", G), p.on("blur", function() {
